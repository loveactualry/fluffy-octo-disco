...
print('sqlite3.sqilite_version :', sqlite3.sqlite_version)

# DB 생성 & Auto Commit(Rollback)
conn = sqlite3.connect('c:/pythonbasic/resource/database.db', isolation_level=None) #AutoCommit mode

# Cursor
c = conn.cursor()
print('Cursor Type : ', type(c)) # 단위 테스트라 한다.
